...
//
// - 입력
// 첫 번째 줄에 0보다 크고 100보다 작은 세 정수 d_1, d_2, X가 공백으로 구분되어 주어진다.
// 서로 다른 두 정수 d_1, d_2는 기념주화를 이루는 두 가지 금속의 밀도이다. 단위는 g/cm^3 이다.
// X는 두 가지 금속 중 밀도가 더 높은 쪽이 기념주화에서 차지하는 질량의 비율로, 단위는 % 이다.
//
// - 출력
// 첫 번째 줄에 기념주화의 밀도를 g/cm^3 단위를 생략한 채 출력한다. 절대 및 상대오차는 10^{-6} 까지 허용한다.
