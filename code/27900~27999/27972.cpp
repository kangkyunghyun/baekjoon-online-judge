...
// 음 하나를 연주해야 할 때마다 1부터 양의 정수 N까지의 정수 중 하나를 쓴다.
...
// 악보 읽기의 달인이 된 키위새는 주어진 악보를 위 규칙에 따라 수열로 옮겨 동영상 사이트에 피아노 연주 동영상을 올리기로 했다.
// N이 클수록 연주할 음의 종류가 많아지므로 사람들이 영상을 어렵게 느낄 수 있으므로 영상을 사람들이 어렵게 느끼지 않도록 N의 최솟값을 찾아주자.
//
// - 입력
// 첫째 줄에 악보에서 연주해야 할 음의 개수 M이 주어진다. (1 ≤ M ≤ 500,000)
// 둘째 줄에 악보에 쓰인 음의 높이를 나타내는 정수 p_1, p_2, \cdots, p_M이 공백으로 구분되어 주어진다. (1 ≤ p_i ≤ 10^9)
