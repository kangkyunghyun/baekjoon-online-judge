...
### 입력 
 ...
 <p>첫째 줄에 <span style="color:#e74c3c;"><code>O</code></span>와 <span style="color:#e74c3c;"><code>X</code></span>로 이루어진 문자열이 주어진다. 문자열의 길이는 $1$ 이상 $100\,000$ 이하이다.</p>

### 출력 

 <p>첫째 줄에 연산의 횟수를 $10^9 + 7$로 나눈 나머지를 출력한다.</p>
