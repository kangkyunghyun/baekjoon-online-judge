...
//
// - 입력
// 첫 번째 줄에 시간을 의미하는 정수 T (0 ≤ T ≤ 23)와 술의 유무를 의미하는 정수 S (0 ≤ S ≤ 1)가 공백으로 구분되어 주어진다. T가 11이하이면 아침 시간, 12이상 16 이하이면 점심 시간, 그렇지 않으면 저녁 시간을 뜻한다. S가 1 이면 술과 함께 먹는 것을 의미하며, 0 이면 술 없이 초밥을 먹는 것을 의미한다.
//
// - 출력
